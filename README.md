...
서비스 기획 및 구상 등에 인풋을 줄이기 위해 기존에 있는 서비스를 기반으로 클론 코딩을 하였습니다.
---
...
- Github-flow를 사용해 각자의 작업물은 feature 브랜치를 만들어 관리했으며, 완성한 작업물은 main 브랜치에 Squash Merge 전략을 사용해 합쳤습니다.  
...
- 아래와 같은 근거로 Merge 전략은 Squash Merge 전략을 택했습니다.
  ...
  - PR을 날리는 단위를 작게하자고 미리 협의한 점
  - 각자 작업물의 히스토리는 main 브랜치에 남기기보다는 로컬에 남겨 관리하는 것이 편하겠다고 판단한 점
    ![](../../../../../../var/folders/bx/x5504p8x75j2f7y4m82hh9k80000gn/T/TemporaryItems/NSIRD_screencaptureui_sZlOz2/스크린샷 2023-02-01 오전 2.12.51.png)


![](../../../../../../var/folders/bx/x5504p8x75j2f7y4m82hh9k80000gn/T/TemporaryItems/NSIRD_screencaptureui_ICn4sn/스크린샷 2023-02-01 오전 2.15.19.png)
...
4. [회원 가입에 Redis를 쓰게된 계기](https://kjhoon0330.tistory.com/entry/Spring-Dev-%EC%9B%B9%EC%86%8C%EC%BC%93%EC%97%90-%EB%8C%80%ED%95%98%EC%97%AC)
5. [N + 1 문제 해결](https://kjhoon0330.tistory.com/entry/Spring-Dev-%EC%9B%B9%EC%86%8C%EC%BC%93%EC%97%90-%EB%8C%80%ED%95%98%EC%97%AC)
...
---
## DB Diagram
![](../../../../Downloads/스크린샷 2023-01-31 오후 5.04.13.png)
